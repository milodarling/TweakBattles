...
#define tweakSettingsPath @"/User/Library/Preferences/com.cpdigitaldarkroom.spotcleaner.plist"


@implementation CPSpotCleanerListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[CPSpotCleanerLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
