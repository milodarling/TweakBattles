#import "CPSpotCleanerTweakBattlesListController.h"
#import "CPSpotCleanerPreferences.h"

@implementation CPSpotCleanerTweakBattlesListController

-(id)specifiers {
    if(_specifiers == nil) {
        _specifiers = [super specifiersForPlistName:@"SpotCleanerTweakBattles"];
    }
    [self setTitle:[[CPSpotCleanerLocalizer sharedLocalizer] localizedStringForKey:@"TWEAKBATTLES"]];
    return _specifiers;
}
