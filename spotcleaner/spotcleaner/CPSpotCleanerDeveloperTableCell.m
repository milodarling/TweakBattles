#import "CPSpotCleanerDeveloperTableCell.h"
#import "CPSpotCleanerPreferences.h"

@implementation CPSpotCleanerDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CPSpotCleanerDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    NSBundle *settingsBundle = [CPSpotCleanerLocalizer sharedLocalizer].localizationBundle;
