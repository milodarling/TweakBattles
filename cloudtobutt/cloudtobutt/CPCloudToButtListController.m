...
#define tweakSettingsPath @"/User/Library/Preferences/com.cpdigitaldarkroom.cloudtobutt.plist"


@implementation CPCloudToButtListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[CPCloudToButtLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
