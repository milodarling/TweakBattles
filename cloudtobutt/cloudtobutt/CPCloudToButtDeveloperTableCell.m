#import "CPCloudToButtDeveloperTableCell.h"
#import "CPCloudToButtPreferences.h"

@implementation CPCloudToButtDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CPCloudToButtDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    NSBundle *settingsBundle = [CPCloudToButtLocalizer sharedLocalizer].localizationBundle;
