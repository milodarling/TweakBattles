...
#define tweakSettingsPath @"/User/Library/Preferences/com.cpdigitaldarkroom.safariwallsetter.plist"


@implementation CPSafariWallSetterListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[CPSafariWallSetterLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
