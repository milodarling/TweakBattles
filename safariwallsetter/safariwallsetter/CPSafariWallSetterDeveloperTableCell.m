#import "CPSafariWallSetterDeveloperTableCell.h"
#import "CPSafariWallSetterPreferences.h"

@implementation CPSafariWallSetterDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CPSafariWallSetterDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    NSBundle *settingsBundle = [CPSafariWallSetterLocalizer sharedLocalizer].localizationBundle;
