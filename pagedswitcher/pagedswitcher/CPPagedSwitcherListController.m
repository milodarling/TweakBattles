...
#define tweakSettingsPath @"/User/Library/Preferences/com.cpdigitaldarkroom.pagedswitcher.plist"


@implementation CPPagedSwitcherListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[CPPagedSwitcherLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
