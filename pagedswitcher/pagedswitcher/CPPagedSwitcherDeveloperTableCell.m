#import "CPPagedSwitcherDeveloperTableCell.h"
#import "CPPagedSwitcherPreferences.h"

@implementation CPPagedSwitcherDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CPPagedSwitcherDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    NSBundle *settingsBundle = [CPPagedSwitcherLocalizer sharedLocalizer].localizationBundle;
