...
#define tweakSettingsPath @"/User/Library/Preferences/com.cpdigitaldarkroom.tayrotator.plist"


@implementation CPTayRotatorListController

- (id)specifiersForPlistName:(NSString *)plistName {
    NSArray *specs = [[self loadSpecifiersFromPlistName:plistName target:self] retain];
    return [[CPTayRotatorLocalizer sharedLocalizer] localizedSpecifiersForSpecifiers:specs];
}
