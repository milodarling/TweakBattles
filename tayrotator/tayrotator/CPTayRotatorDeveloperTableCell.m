#import "CPTayRotatorDeveloperTableCell.h"
#import "CPTayRotatorPreferences.h"

@implementation CPTayRotatorDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CPTayRotatorDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    NSBundle *settingsBundle = [CPTayRotatorLocalizer sharedLocalizer].localizationBundle;
