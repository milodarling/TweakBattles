#import "CPQuickSwipeDeveloperTableCell.h"
#import "CPQuickSwipePreferences.h"

@implementation CPQuickSwipeDeveloperTableCell
...
-(id)initWithDevName:(NSString *)devName realName:(NSString *)realName jobSubtitle:(NSString *)job devImage:(UIImage *)devImage {
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CPQuickSwipeDeveloperTableCell"];
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)spec {
    NSBundle *settingsBundle = [CPQuickSwipeLocalizer sharedLocalizer].localizationBundle;
